function Login()
{
    return(
        <div className="h-screen flex items-center justify-center">
            ...
            <button className="bg-indie-100 flex gap-8 text-xl p-2 rounded-lg w-72 items-center justify-center h-16 cursor-pointer"><span>
            ...
            <button className="bg-cyan-500 flex gap-8 text-xl p-2 rounded-lg w-72 items-center justify-center h-16 cursor-pointer">
            <span>
            ...
            <form className="w-full text-indie-200 flex flex-col gap-2 mt-2">
                <label htmlFor="email">Email</label>
                <input type="email" placeholder="email@example.com" className="border-2 border-indie-200 rounded-sm p-2"/>
